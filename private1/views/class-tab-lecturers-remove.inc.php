<form method="post" class="form mx-auto" style="width:100%;max-width: 400px;">
  <br><center> <h4>Remove Teacher</h4> </center>
...
<?php endif;?>
    ...
    <input value="<?=get_var('name')?>" autofocus class="form-control" type="text" name="name" placeholder= "enter teacher's name">
    <br>
...
<?php if(isset($results) && $results):?>
  ...
  <?php else: ?>
    ...
    <center><hr><h4>No teacher was found</h4></center>
    <?php endif; ?>
<?php endif; ?>
</form>
</div>